                    ...
                    <div className="grid grid-cols-2 gap-8 py-5 lg:py-10 md:grid-cols-5">
                        <div className="col-span-2">
                            <div className="lg:flex lg:items-start lg:gap-8">
                                <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 49" className="h-20" fill="#978F6B">
                                    <defs>
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-gray-900">Get the latest news!</h3>
                        ...
                        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                            <form className="w-full">
                                ...
                                <div
                                    className="border border-gray-300 p-2 focus-within:ring-1 ring-black sm:flex sm:items-center sm:gap-4"
                                >
                                    <input
                                        type="email"
                                        id="UserEmail"
                                        placeholder="youremail@domain.xyz"
                                        className="w-full border-none focus:outline-0 focus:ring-transparent sm:text-sm p-2"
                                    />
                                    <Button className="mt-1 w-full bg-black text-white px-6 py-3 tracking-wide transition-none sm:mt-0 sm:w-auto sm:shrink-0">Sign Up</Button>
                                </div>
                            </form>
                        </div>
                    </div>
